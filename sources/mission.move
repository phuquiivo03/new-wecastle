...
//     use sui::package;
//     use sui::display;
//     use wecastle::wecastle::{CorbaGameFi, CorbaPlayer, claim, get_player_id};
...
//     public struct GameMission has key, store {
//         id: UID,
//         total_works: u64
//     }
...
//     public fun new(
//         mut player: CorbaPlayer,
//         ctx: &mut TxContext) {

//         let id = *get_player_id(&mut player, ctx);
